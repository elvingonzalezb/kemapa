...
$route['(.*)-([0-9]+)/subcategorias'] = 'frontend/productos/subCat';
...
$route['producto/([0-9]+)-(.*)'] = 'frontend/productos/detallesProductos';

$route['producto/([0-9]+)-(.*)-([0-9]+)'] = 'frontend/productos/detallesProductos';
...
$route['registrate/activacion/([0-9]+)'] = 'frontend/activacion';

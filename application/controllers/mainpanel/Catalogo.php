...
class Catalogo extends CI_Controller {
    ...
    public function index() {
     ...
     ////////////////////BEGIN CATEGORIAS///////////////
     ////////////////////BEGIN CATEGORIAS///////////////
     public function corrigeUrl() {
            $this->Catalogo_model->corrigeUrl();
    ...
    public function listadoSubCategoriaFilter($id_categoriafilter)
        ...
        public function listadoProductosFilter($id_filter)
        {
            $this->validacion_mainpanel->validacion_login();
           ...
           $aux = $this->Catalogo_model->getListaFilterCatProd($id_filter);
           $productos = array();

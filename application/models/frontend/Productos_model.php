<?php
    ...
    public function getProductosxPagina($inicio, $limite) {
      ...
      public function numTotalNuevosProductos() {
    ...
    public function getNuevosProductosxPagina($inicio, $limite) {
        $this->db->where('destacado', '0');
        $this->db->order_by('nom_producto');
        $this->db->limit($limite, $inicio);
        $query =  $this->db->get('productos');
    ...
    public function getProdxCatProd($id_subcategoria) {
    ...
    public function getNombreSubCategoria($id_subcategoria) {
        $this->db->select('nombre, id_categoria');
        $this->db->where('id_subcategoria', $id_subcategoria);
        $query =  $this->db->get('subcategorias');
       return $query->row();
    }

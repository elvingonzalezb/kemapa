...
<tr>
	<td width="600" align="center" style="background:#fff;">
		...
		<tr>
			<td height="20"></td>
			<td>
				<p>Puede empezar a usar nuestros servicios. Para ello haga click en el siguiente boton:<br><br>
					<a href="<?php echo base_url().'frontend/ingresar' ?>" class="boton">INGRESAR</a></p>
			</td>
			<td></td>
		</tr>
		<tr>

...
<link href="assets/frontend/img/favicon.png" rel="shortcut icon" type="image/png">
<link rel="apple-touch-icon" sizes="57x57" href="assets/frontend/img/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="assets/frontend/img/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="assets/frontend/img/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="assets/frontend/img/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="assets/frontend/img/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="assets/frontend/img/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="assets/frontend/img/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="assets/frontend/img/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="assets/frontend/img/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192"  href="assets/frontend/img/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="assets/frontend/img/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="assets/frontend/img/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="assets/frontend/img/favicon-16x16.png">
<link rel="manifest" href="/manifest.json">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="assets/frontend/img//ms-icon-144x144.png">
<meta name="theme-color" content="#ffffff">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/frontend/img/favicon-32x32.png">
            ...
            <div class="col-md-8">
                <div class="linksTop">
                  <ul>
                      ...
                      <li>|</li>
                      <li><a href=""><i class="fa fa-clock-o"></i> <?php echo getConfig('horario_especial'); ?></a></li>
                      <li>|</li>
                      <li><a href=""><i class="fa fa-phone"></i> <?php echo getConfig('telefono_footer'); ?></a></li>
                  </ul>
                </div><!-- /.social-icons -->
            </div><!-- /.cnt-account -->
                 ...
                 if($this->session->userdata('usermercasub_registrado'))
                  {
                    ...
                    echo'<li><a href="editdatos"><i class="icon fa fa-user"></i>'.$this->session->userdata('usuario_email').'</a></li>';
                   ...
                   else
                   {
                      ...
                      if($fb!="")
                      {
                         echo '<li><a href="'.$fb.'" target="_blank" class="active" ><i class="icon fa fa-facebook"></i></a></li>';
                      }
                      ...
                      echo'<li><a href="registrate">REGISTRARSE</a></li>';
                      ...
                      <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                          <ul class="nav navbar-nav">
                            ...
                            <li
                              <?php if($seccion=="nuevosproductos") echo 'class="active"'; ?>><a href="nuevosproductos">Nuevos Productos</a>
                            </li>

                             <li
                              <?php if($seccion=="articulos") echo 'class="active"'; ?>><a href="articulos">Blog</a>
                            </li>

                            <li
                              <?php if($seccion=="contactanos") echo 'class="active"';?>><a href="contactanos">Contáctenos</a>
                            </li>

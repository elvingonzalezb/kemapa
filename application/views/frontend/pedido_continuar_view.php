          ...
          echo'<table class="table table-bordered">';
                  echo'<thead>';
                    echo'<tr>';
                      ...
                      echo'<th class="cart-sub-total item">Observaciones</th>';
                    echo'</tr>';
                  echo'</thead>';
                       ...
                       echo' <div class="shopping-cart-btn">';
                         echo' <span class="">';
                           //echo' <a href="pedidos" class="btn btn-upper btn-primary outer-left-xs bg">Editar</a>';
                            echo'<button type="submit" class="btn btn-upper btn-fucsia pull-right outer-right-xs bg">Aceptar</button>';
                 ...
                 foreach ($pedido as $item) {
                    ...
                    echo'<tbody>';
                      echo'<tr>';
                        ...
                        echo'<td class="cart-product-grand-total">';
                        ...
                        echo'<td class="cart-product-coment">';
                        echo'<span class="product-color">'.$item['item_cantidad'].'</span>';
                        echo'</td>';

                        echo'<td class="cart-product-coment">';
                          echo'<textarea name="observaciones" id="observaciones class="form-control no-required uptcoment" rows="4">'.$item['item_observaciones'].'</textarea>';
                        echo'</td>';

                  ...
                  foreach ($carrito as $key => $item): ?>
                    ...
                    <tbody>
                      ...
                      <td class="cart-product-quantity">
                        ...
                        <input type="text" name="item[<?=$key?>][item_cantidad]" onblur="updateCantidad('<?=$key?>')" size="3" title="Cantidad" value="<?=$item['item_cantidad']?>" id="cant_<?=$key?>" class="input-cantidad" >

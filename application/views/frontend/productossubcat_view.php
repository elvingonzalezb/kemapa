    ...
    <div class='container'>
        <div class='row outer-bottom-sm'>
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 sidebar">
               ...
               <?php
                   $cat = strtoupper($nomSubCategoria->nombre);
                ...
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-12 wow fadeInUp">
                     <?php
                      ...
                      for($i=0; $i<count($productos); $i++)
                      {
                        ...
                        $enlace = "producto".'/'.$id_producto.'-'.$url;

                        echo'<div class="product col-md-4 mgb-20 col-xs-6 col-sm-6"> ';
                              echo'<div class="product-image">';
                                 echo'<div class="image">';
                                      echo'<a href="'.$enlace.'"><img src="files/productos/medianas/'.$imagen.'" alt="'.$nom_producto.'"></a>';
                                  echo'</div> ';
                              echo'</div>';
                             ...
                             echo' <div class="product-info text-left">';
                                  echo '<div class="divNombreProd">';
                                      ...
                                      echo '</div>';
                                  echo '</div>';                               
                                  //echo' <h3 class="name"><a href="'.$enlace.'">'.$nom_producto.'</a></h3>';
                             echo'</div>';
                                    ...
                                    echo'<div class="cart clearfix animate-effect">';
                                      echo'<div class="action">';
                                        echo'<ul class="list-unstyled">';
                                             ...
                                             echo'<li class="lnk">';
                                            echo'<a class=" btn btn-primary add-to-cart" href="'.$enlace.'" title="Detalles">';

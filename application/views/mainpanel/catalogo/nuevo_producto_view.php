            ...
            <form class="form-horizontal" action="mainpanel/catalogo/grabar" method="post" enctype="multipart/form-data" onsubmit="return validaProducto()">
                <fieldset>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="alert alert-success span10">
                                    <p><strong>La imagen a subir debe tener dimensiones de 800 x 800 pixeles. Caso contrario la imagen se forzará al tamaño indicado.</strong></p>
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
                   ...
                   <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label">Producto Nuevo</label>
                            <div class="controls">
                                <label class="radio">
                                    <input type="radio" name="destacado" id="destacado1" value="1" checked="checked"> No </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <input type="radio" name="destacado" id="destacado2" value="0"> Si </label>
                            </div>
                        </div>

                   ...
                   <!-- categoria principal -->
                    <div class="control-group">
                        ...
                        <div class="controls span10">
                            <select name="id_categoria" id="id_categoria" onchange="cargaProductosColor(this.value)">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls span10" id="divSubcategorias">
                            <select name="id_subcategoria" id="id_subcategoria" onchange="cargaProductos(this.value)">

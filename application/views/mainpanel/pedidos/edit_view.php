                    ...
                    <?php 
                       if($this->session->userdata('success'))
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="span6"><embed src="files/stock/<?php echo $stock->archivo; ?>" width="500" height="375" accept="application/msword, .doc, .docx, application/msexcel, .xls, .xlsx, application/pdf"></div>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
